    ...
    <div class="other-home">
        ...
        <mt-loadmore :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore">
            ...
            <section v-if="selectIndex==1" class="follow">
                ...
                <ul @click="userHome(item.id)" v-for="item in otherFollowList" class="cell">
                    <div class="cell-left">
                    ...
                    <div class="cell-right">
                        ...
                        <div  v-if="item.followStatus === 121" @click.stop="userFollow(item.id,item.followStatus)" class="cell-right-attentioned-ac">已关注</div>
                        <div v-if="item.followStatus === 123" @click.stop="userFollow(item.id,item.followStatus)" class="cell-right-attentioned-ac">互相关注</div>
                    </div>
                </ul>
            </section>
            <!--粉丝队列-->
            <section v-if="selectIndex==2" class="follow">
                ...
                <ul @click="userHome(item.id)" v-for="item in otherFanList" class="cell">
                    <div class="cell-left">
                        <img class="cell-left-img" :src="item.avatar">
                        <div class="cell-left-mid">
                            <div class="top" v-text="item.nickname"></div>
                    ...
                    <div class="cell-right">
                        ...
                        <div v-if="item.followStatus === 121" @click.stop="FanFollow(item.id,item.followStatus)" class="cell-right-attentioned-ac">已关注</div>
                        <div v-if="item.followStatus === 123" @click.stop="FanFollow(item.id,item.followStatus)" class="cell-right-attentioned-ac">互相关注</div>
                    </div>
                </ul>
            </section>
...
//            this.getOtherFanList(this.start, this.offset);
        ...
        methods: {
            ...
            //粉丝关注
            FanFollow:function (id,followStatus) {
                if (!UTIlS.getSkey()) {
                    this.$router.push({name: 'loginA'});
                    return;
                }
