<template>
    <div @click="topicDetail()" class="topic-cell-content">
        <div @click.stop="otherDetail(item.author.id)" class="avatar-content">
            <img v-if="item.author.avatar" class="avatar-img" :src="item.author.avatar" >
            <img v-else="" class="avatar-img" src="../assets/images/log.png" >
            <div class="avatar-text"  v-text="item.author.nickname"></div>
        </div>
        ...
        <div class="bottom-content">
            ...
            <div class="bottom-right">
                <div class="bottom-see">
                    ...
                    <div class="bottom-see-num" v-text="item.viewCount"></div>
                </div>
                <div class="bottom-col">
                    <img class="bottom-col-see-img" src="../assets/images/home_comment_icon.png">
                    <div class="bottom-col-see-num" v-text="item.commentCount"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    export default{
        ...
        methods:{
            ...
            brief:function (brief) {
                if (brief.length>60){
                    var  delBreif = brief.substring(0,60) ;
                    return delBreif += '。。。';
                }else {
                    return brief ;
                }
...
<style scoped>
    ...
    .topic-cell-content .bottom-content .bottom-right .bottom-see .bottom-see-img {
        width: 14px;
        height: 14px;
        margin-right: 5px;
    }
    ...
    .topic-cell-content .bottom-content .bottom-right .bottom-col .bottom-col-see-img {
        width: 10px;
        height: 10px;
        margin-right: 5px;
    }
